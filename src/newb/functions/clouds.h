...
// sky-match helpers: din me 0, raat me ~1.
// raat me clouds sky ke rang me ghul jaye, safed patch na lage.
...
float nlCloudNightBlend(vec3 skyTint) {
  return 1.0 - clamp(dot(skyTint, vec3_splat(0.33))*0.85, 0.0, 1.0);
}

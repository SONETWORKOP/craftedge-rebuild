...
#define NL_SHADOW_INTENSITY     0.7    // halki parchai din me (kalapan kam, shape same)
...
#define NL_DAY_REFL_TINT   vec3(0.92, 1.0, 1.08)   // din: halka cool crisp blue
...
#if defined(VIBRANT_CLOUD) || defined(NO_REFLECTIONS)
  #undef NL_CLOUD_TYPE
